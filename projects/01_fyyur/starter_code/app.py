...
from models import db_setup, Venue, Artist, Show, VenueGenre, ArtistGenre
#----------------------------------------------------------------------------#
# App Config.
#----------------------------------------------------------------------------#
  ...
  # search for "Music" should return "The Musical Hop" and "Park Square Live Music & Coffee"
	...
	for result in new_results:
		data.append({
			'id': result.id,
			'name': result.name,
			'num_upcoming_shows': len(db.session.query(Show).filtr(Show.venue_id == result.id).filter(Show.start_time > datetime.now()).all()),
		})
